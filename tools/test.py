...
def parse_args():
    ...
    # parser.add_argument(
    #     "--config", default=r"configs/graph_transformer/gt_224x224_40k_slovenia.py", help="test config file path"
    # )
    # parser.add_argument(
    #     "--checkpoint",
    #     default=r"work_dirs/gt_224x224_40k_slovenia/train_20241020_092042/iter_40000.pth",
...
def main():
    ...
    if not distributed:
        ...
        outputs = single_gpu_test(model, data_loader, args.show, args.show_dir, save_gt=False, background=cfg.background)
    else:
