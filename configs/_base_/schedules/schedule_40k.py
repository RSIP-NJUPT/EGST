...
# optimizer = dict(type="AdamW", lr=1.176e-06, weight_decay=1e-5)
...
checkpoint_config = dict(by_epoch=False, interval=interval, max_keep_ckpts=3, create_symlink=False, save_optimizer=True)
